    ...
    return (
        ...
        <div className="flex card">
            ...
            <div className="ml1">
                ...
                <div className="f6 flex items-end lh-copy gray">
                  <div className="mr1"> {link.votes.length} votes by {link.postedBy.name} {distanceToWordsToNow(link.created)} </div>
                  {" | "}
                  ...
                  {postedByAuthUser && (
                    ...
                    <span className="delete-button ml1" onClick={handleDeleteLink}> Delete </span>
                    </>
                  )}
                </div>
            </div>
